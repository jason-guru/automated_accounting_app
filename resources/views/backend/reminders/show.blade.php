...
@section('title', 'Reminders | Show Reminder')
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    Reminder Management
                    <small class="text-muted">View Reminder</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#contact-person" role="tab" aria-controls="overview" aria-expanded="true"><i class="fas fa-clock"></i> Reminders</a>
                    </li>
                </ul>

                <div class="tab-content">
                    <div class="tab-pane active show" id="contact-person" role="tabpanel" aria-expanded="true">
                        @include('backend.reminders.show.tabs.details')
                    </div><!--tab-->
                </div><!--tab-content-->
            </div><!--col-->
        </div><!--row-->
