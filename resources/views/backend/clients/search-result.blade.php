                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="accounts_next_due" value="{{$client_data['accounts']['next_due']}}">
                            <input type="hidden" name="accounts_overdue" value="{{$client_data['accounts']['overdue'] == false ? 0 : 1}}">
                        </div>
                    </div>
                </div>
            </div>
