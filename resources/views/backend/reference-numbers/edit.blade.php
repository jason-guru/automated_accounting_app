        ...
        <form action="{{route('admin.reference-numbers.update', ['id' => $reference_number->id])}}" method="post" enctype='multipart/form-data'>
            ...
            @method('PUT')
                <div class="form-group mt-4">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="{{$reference_number->name}}" placeholder="Enter a unique reference name">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reference_number" id="reference-number" class="form-control" value="{{$reference_number->reference_number}}" placeholder="Enter the reference number">
                </div> 
                <label for="amount">Amount</label>
                    ...
                    <input type="text" name="amount" class="form-control" id="amount" aria-describedby="basic-addon3" value="{{$reference_number->amount}}" placeholder="Enter amount">
                </div>
                <div class="form-group">
